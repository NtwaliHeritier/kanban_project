# defmodule KanbanProject.AdminTest do
#   use KanbanProject.DataCase

#   alias KanbanProject.Admin

#   describe "users" do
#     alias KanbanProject.Admin.User

#     import KanbanProject.AdminFixtures
